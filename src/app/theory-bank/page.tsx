...
const concepts: Concept[] = [
  ...
  {
    id: 'aggregate-supply', title: 'Aggregate Supply (AS)', category: 'Macroeconomic Framework', level: 'A-Level',
    summary: 'The total output of goods and services that producers in an economy are willing and able to supply at different price levels in a given time period.',
    detail: 'Aggregate Supply (AS) represents the total production capacity of an economy. It is commonly shown on AD/AS diagrams and is central to macroeconomic analysis. Short-run AS slopes upward as firms supply more at higher prices, while long-run AS is vertical at the productive capacity of the economy.',
    keyPoints: ['Used in macroeconomics to analyse economic growth, inflation, and productive capacity.', 'Commonly shown on AD/AS diagrams.', 'Changes in AS can be caused by changes in costs of production, productivity, taxation, or technology.'],
    tags: ['AS', 'Supply', 'Macroeconomics', 'AD/AS', 'Productive Capacity'],
  },
  {
    id: 'gdp', title: 'GDP', category: 'Macroeconomic Framework', level: 'A-Level',
    summary: 'The value of all final goods and services produced within an economy in a given time period.',
    detail: 'Gross Domestic Product (GDP) is the primary measure of the size of an economy. It counts the value of all final goods and services produced within a country\'s borders, regardless of who produces them. GDP is used to assess economic performance and compare economies over time.',
    keyPoints: ['Used to measure the size of an economy.', 'A key indicator of economic performance.', 'Often compared across years to assess growth.'],
    tags: ['GDP', 'Output', 'Economic Growth', 'Measurement', 'National Income'],
  },
  {
    id: 'gdp-per-capita', title: 'GDP per Capita', category: 'Macroeconomic Framework', level: 'A-Level',
    summary: 'GDP divided by the population of a country.',
    detail: 'GDP per capita adjusts total GDP for population size, making it a more useful measure when comparing countries of different sizes. It is widely used as an indicator of average living standards and economic wellbeing, though it does not account for income distribution.',
    keyPoints: ['Commonly used as an indicator of average living standards.', 'Useful when comparing countries with different population sizes.', 'Often provides a better measure of economic wellbeing than total GDP alone.'],
    tags: ['GDP per Capita', 'Living Standards', 'Comparison', 'Population', 'Wellbeing'],
  },
  {
    id: 'real-gdp', title: 'Real GDP', category: 'Macroeconomic Framework', level: 'A-Level',
    summary: 'GDP adjusted for inflation.',
    detail: 'Real GDP removes the effects of changes in the price level from GDP figures, allowing for more accurate comparisons of economic output over time. Unlike nominal GDP, real GDP reflects actual changes in the volume of goods and services produced rather than changes in prices.',
    keyPoints: ['Provides a more accurate measure of economic growth than nominal GDP.', 'Used when comparing economic output over time.', 'Removes the effects of changes in the price level.'],
    tags: ['Real GDP', 'Inflation', 'Nominal GDP', 'Economic Growth', 'Price Level'],
  },
  {
    id: 'gnp', title: 'Gross National Product (GNP)', category: 'Macroeconomic Framework', level: 'A-Level',
    summary: 'The value of goods and services produced by the citizens of a country, regardless of where they are located.',
    detail: 'GNP measures the total economic output generated by a nation\'s citizens and firms, whether they are located domestically or abroad. It differs from GDP in that it includes income earned abroad by domestic residents and firms, but excludes income earned domestically by foreign residents and firms.',
    keyPoints: ['Includes income earned abroad by domestic residents and firms.', 'Excludes income earned domestically by foreign residents and firms.', 'Measures economic output generated by a nation\'s citizens rather than production within its borders.'],
    tags: ['GNP', 'National Income', 'Citizens', 'GDP', 'Economic Output'],
  },
  {
    id: 'inflation', title: 'Inflation', category: 'Inflation & Unemployment', level: 'A-Level',
    summary: 'A sustained increase in the general price level over time.',
    detail: 'Inflation reduces the purchasing power of money and is usually measured using the Consumer Price Index (CPI). Maintaining low and stable inflation is a key macroeconomic objective for most governments and central banks. Inflation can be caused by demand-pull factors (excess aggregate demand) or cost-push factors (rising production costs).',
    keyPoints: ['Usually measured using CPI.', 'Reduces the purchasing power of money.', 'A major macroeconomic objective is maintaining low and stable inflation.'],
    tags: ['Inflation', 'CPI', 'Price Level', 'Purchasing Power', 'Macroeconomic Objectives'],
  },
  {
    id: 'deflation', title: 'Deflation', category: 'Inflation & Unemployment', level: 'A-Level',
    summary: 'A sustained decrease in the general price level over time.',
    detail: 'Deflation occurs when the general price level falls over a sustained period. While lower prices may seem beneficial, deflation can be harmful as it reduces consumer spending (consumers delay purchases expecting further price falls), weakens investment, and increases the real burden of debt. It is often associated with weak aggregate demand and can lead to lower economic growth and higher unemployment.',
    keyPoints: ['Can reduce consumer spending and investment.', 'Often associated with weak aggregate demand.', 'May lead to lower economic growth and higher unemployment.'],
    tags: ['Deflation', 'Price Level', 'Aggregate Demand', 'Economic Growth', 'Unemployment'],
  },
  {
    id: 'quantitative-easing', title: 'Quantitative Easing (QE)', category: 'Policy', level: 'A-Level',
    summary: 'A monetary policy where a central bank creates new money electronically to purchase financial assets, increasing liquidity in the economy.',
    detail: 'Quantitative Easing is an unconventional monetary policy tool used when traditional interest rate cuts are no longer effective (typically when rates are already near zero). The central bank creates new money electronically and uses it to purchase financial assets such as government bonds, injecting liquidity into the financial system and stimulating economic activity.',
    keyPoints: ['Used when interest rates are already very low.', 'Intended to stimulate spending, investment, and economic activity.', 'Commonly used during recessions or financial crises.'],
    tags: ['QE', 'Monetary Policy', 'Central Bank', 'Liquidity', 'Interest Rates'],
  },
  {
